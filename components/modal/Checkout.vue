	...
	<div :class="[ openModal ? 'is-active' : '', 'modal' ]">
		...
		<div class="modal-card">
			...
			<section class="modal-card-body">
				<div v-if="!isCheckoutSection">
					<div class="box" v-for="product in products" :key="product.id">
						<button class="is-pulled-right button is-inverted" @click="removeFromCart(product.id)">{{ removeLabel }}</button>
			...
			<footer class="modal-card-foot">
				<button v-show="products.length > 0 && !isCheckoutSection" class="button is-primary" @click="onNextBtn">{{ buyLabel }}</button>
